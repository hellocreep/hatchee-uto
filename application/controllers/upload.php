...
class Upload extends CI_Controller {
    ...
    protected $path_img_middel_upload_folder;
    protected $path_url_img_upload_folder;
    protected $path_url_img_thumb_upload_folder;
    protected $path_url_img_middel_upload_folder;
...
//Set relative Path with CI Constant
		...
		if($this->mkdirs("uploads/images"))
		{
        	$this->setPath_img_upload_folder("uploads/images/");
		}
  		if($this->mkdirs("uploads/thumbnails/"))
		{
        	$this->setPath_img_thumb_upload_folder("uploads/thumbnails/");
		}
  		if($this->mkdirs("uploads/middels/"))
		{
        	$this->setPath_img_middel_upload_folder("uploads/middels/");
		}
...
//Delete img url
        $this->setDelete_img_url(base_url() . 'uploads/deleteImage/');
 

//Set url img with Base_url()

        $this->setPath_url_img_upload_folder(base_url() . "uploads/images");
        $this->setPath_url_img_thumb_upload_folder(base_url() . "uploads/thumbnails/");
       	$this->setPath_url_img_middel_upload_folder(base_url() . "uploads/middels/");
...
// remplacer les caracteres autres que lettres, chiffres et point par _
       ...
       if ($this->do_upload()) {
			...
			$config['new_image'] = $this->getPath_img_middel_upload_folder();
            $config['image_library'] = 'gd2';
            $config['source_image'] = $this->getPath_img_upload_folder() .$config['file_name'];
            $config['create_thumb'] = FALSE;
            $config['maintain_ratio'] = TRUE;
...
*/
	...
	public function getPath_img_middel_upload_folder() {
        return $this->path_img_middel_upload_folder;
    }

    public function setPath_img_middel_upload_folder($path_img_middel_upload_folder) {
        $this->path_img_middel_upload_folder = $path_img_middel_upload_folder;
    }
	...
	public function getPath_url_img_middel_upload_folder() {
        return $this->path_url_img_middel_upload_folder;
    }

    public function setPath_url_img_middel_upload_folder($path_url_img_middel_upload_folder) {
        $this->path_url_img_thumb_middel_folder = $path_url_img_middel_upload_folder;
    }
