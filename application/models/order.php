...
class Order extends CI_Model
{
	...
	public function gettailormade($page)
	{
		$step = 15;
		$begin = ($page-1) * $step;
		$query=$this->db->query("select c.Id as id, c.uuid as orderid,c.create_date as ordertime,c.is_worked,c.handle_time,c.tour_time as tourtime,u.name as username,u.Id as uid from custom_inquiry as c left join users as u on c.user=u.Id order by is_worked limit " .$begin.",".$step);
		$data=$query->result();
		return $data;
	}
