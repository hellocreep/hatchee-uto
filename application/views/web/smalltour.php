					...
					<?php  if($tour[0]->tour_type==4):?>
						...
						<div class="describe clearfix">
							<div class="des-l">
								...
								<h5>从友途诞生第一日起，我们就决定：</h5>
								<p>
									1、只做与品质相关的事情！<br>
									2、市面上常规旅游跟团，很多看上去价格很低，但实际上游客最终所支付的费用并不低，因为那些低价团的操作者总是会用带领客人进旅游购物店消费（获取佣金）和增加额外旅游点或者旅游活动的方式来补足旅行社的利润和导游司机的收入。<br>
									3、友途只做纯玩团，也就是不进店、不加点的跟团旅游，表面上价格是高了一些，但最终您为这次旅游所支付的总支出并不高，而且保证了您愉悦的体验和美好的心情！
								</p>
