<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/space_index|template/default/header|template/default/space_status|template/default/space_feed_li|template/default/space_comment_li|template/default/footer', '1344841383', 'template/default/space_index');?><?php $_TPL['nosidebar']=1; ?>
...
<li>
<img src="image/icon/friend.gif"><a href="javascript:;" onclick="getindex('order');">订单<?php if($space['ordernum']) { ?><em>(<?=$space['ordernum']?>)</em><?php } ?></a></li>
</ul>
</div>
