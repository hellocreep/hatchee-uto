<?php if(!defined('IN_UCHOME')) exit('Access Denied');?><?php subtplcheck('template/default/cp_magic|template/default/header|template/default/footer', '1343372639', 'template/default/cp_magic');?><?php if(empty($_SGLOBAL['inajax'])) { ?>
